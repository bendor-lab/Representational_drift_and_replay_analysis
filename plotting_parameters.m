...
function plot_param = plotting_parameters
...
plot_param.RUN1T1 = [252,78,42]/255; % Orangish red
plot_param.RUN1T2 = [107,174,214]/255; % Light blue
plot_param.RUN2T1 = [189,0,38]/255; % Dark red
plot_param.RUN2T2 = [8,81,156]/255; % Dark blue
...
%     for count = 1:3
%         hold on
%         scatter(x(i,count),[2*x(i,count)+2],80,e(i),'filled')
%     end
% end
