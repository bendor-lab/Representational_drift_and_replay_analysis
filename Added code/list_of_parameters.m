...
parameters.max_event_duration = 0.75; %1 sec
parameters.min_react_duration = 0.05;

% for theta sequences detection
parameters.theta_window_width = 0.4;
parameters.max_theta_window_width = 0.2;
parameters.min_theta_window_width = 0.08;
parameters.number_cycle_bins = 10;
parameters.phase_bin_width = 2*pi/parameters.number_cycle_bins;
parameters.min_active_units = 2;
parameters.theta_position_window_width = 40;

% For line fitting
parameters.yRange= 1; %is the deviation from the line in pixels for construct_all_lines.m

% For bayesian decoding
parameters.replay_bin_width = 0.02; %20ms
parameters.thetaseq_bin_width = 0.01; %theta sequence
...
%parameters.plot_color_line = {parameters.colors.purple,parameters.colors.brick,parameters.colors.blue,parameters.colors.orange,'m','g','c','k'};
