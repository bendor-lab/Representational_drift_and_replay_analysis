function significant_replay_events = number_of_significant_replays_final_lap(p_value_threshold,ripple_zscore_threshold, method, rexposure_option)
...
load('replay_control_final_lap\scored_replay_segments.mat')
load('replay_control_final_lap\scored_replay.mat')
...
elseif rexposure_option == 1
    multi_tracks_index = [find(sum(sig_event_info.significance(1:2,:) ,1)>1)];    %check if overlap of tracks in initial exposure or rexposure
...
switch method
    case 'wcorr'
        if ~isempty(rexposure_option) && rexposure_option == 2
            save('replay_control_final_lap\significant_replay_events_wcorr_individual_exposures','significant_replay_events','-v7.3');
        else
            save('replay_control_final_lap\significant_replay_events_wcorr','significant_replay_events','-v7.3');
        end
end
