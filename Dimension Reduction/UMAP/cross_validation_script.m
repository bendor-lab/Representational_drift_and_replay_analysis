...
for session_n = 1:numel(data_folders_excl_legacy)

    disp(session_n);

    currentPath = data_folders_excl_legacy;
    currentPath = currentPath{session_n};
    ...
    writetable(t, "data_cross_validation/data_" + ...
        num2str(session_n) + "_T" + num2str(trackOI)+ ".csv")
