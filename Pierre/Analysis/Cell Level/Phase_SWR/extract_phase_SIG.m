...
function [phasePartMatrice, meanPhaseVector, phaseLocking, significance, unique_cells] = extract_phase_SIG(CSC, sleep_state, significant_replay_events, track)
...
for replayID = 1:numel(sleepSWR)
    dataCurrentRep = significant_replay_events.track(track).spikes{sleepSWR(replayID)};
