...
% CONTROL : use odd replay events for track 1, even for track 2

function [phasePartMatrice, meanPhaseVector, phaseLocking, significance, unique_cells] = extract_phase_NSIG_split(CSC, sleep_state, decoded_replay_events, significant_replay_events, track)
...
% We filter only the odd / even replay events

sleepSWR = sleepSWR(mod(track, 2):2:end);
