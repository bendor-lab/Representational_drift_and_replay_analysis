    ...
    for track = 1:2
        ...
        for exposition = 1:2
            ...
            for lap = 1:nbLaps
                ...
                animalV = [animalV; repelem(animalOI, nbCells)'];
                conditionV = [conditionV; repelem(conditionOI, nbCells)'];
                trackV = [trackV; repelem(track, nbCells)'];
                expositionV = [expositionV; repelem(exposition, nbCells)'];
                lapV = [lapV; repelem(lap, nbCells)'];
                cellV = [cellV; currentData.cell];
