...
% - Day
% - Lap
% - PV correlation with lap 16 - RUN1
% - Euclidian distance with lap 16 - RUN1
% - cosine similarity with lap 16 - RUN1
...
for cfile = sessions
    ...
    testPlaceField = lap_place_fields(1).Complete_Lap{end};
...
save(PATH.SCRIPT + "\..\..\..\Data\population_vector_lapsLap16RUN1.mat", "population_vector_laps");