% PLOT PHASE BIN SHUFFLES AGAINST REAL THETA SEQUENCE SCORE
% MH, 2020
% Plots quadrant ratio, weighted correlation & linear fitting. Loads shuffled distribution and plots it as histogram, and marks with a
% dashed line the 95% percentile. Marks with red solid line the real score for the average theta sequence


function plot_phase_bin_phase_shuffle

load Theta\averaged_thetaSeq_phase_shuffle.mat
...
for d = 1 : length(fields)
    ...
    shuffle =  phase_shuffle.(strcat(fields{d}));
