...
%                 end
                ...
                % Bayesian decoding
                temp_estimated_position.dir1 = bayesian_decoding_lap_thetaseq_1(lap_directional_place_fields(t).dir1.Complete_Lap{1,thisLap},lap_spike_count,t);%lap_place_fields(t).half_Lap{1,thisLap}
                temp_estimated_position.dir2 = bayesian_decoding_lap_thetaseq_1(lap_directional_place_fields(t).dir2.Complete_Lap{1,thisLap},lap_spike_count,t);%lap_place_fields(t).half_Lap{1,thisLap}
...
%                             end
                ...
                [lap_PREspike_train_circ_shuffle_scores(t).Lap{thisLap}, ~] = lap_thetaseq_phase_PRE_spike_circ_shuffle_1(out,lap_directional_place_fields,lap_spike_count,t,thisLap,num_shuffles,0,[]);
