...
for p = 1 : length(session_names)
    ...
    for s = 1 : length(folders)
        ...
        directional_lap_thetaseq = struct;
...
%                 end
                ...
                % Bayesian decoding
                temp_estimated_position.dir1 = bayesian_decoding_lap_thetaseq(lap_directional_place_fields(t).dir1.Complete_Lap{1,thisLap},lap_spike_count,t);%lap_place_fields(t).half_Lap{1,thisLap}
                temp_estimated_position.dir2 = bayesian_decoding_lap_thetaseq(lap_directional_place_fields(t).dir2.Complete_Lap{1,thisLap},lap_spike_count,t);%lap_place_fields(t).half_Lap{1,thisLap}
        ...
        % Save shuffles
        %save('Theta\lap_thetaSeq_PREspikeTrain_circ_shuffle.mat','lap_PREspike_train_circ_shuffle_scores','-v7.3')
        %save('Theta\lap_thetaseq_position_shuffle','lap_position_shuffle','-v7.3') 
        %save('Theta\lap_thetaseq_phase_shuffle','lap_phase_shuffle','-v7.3') 
